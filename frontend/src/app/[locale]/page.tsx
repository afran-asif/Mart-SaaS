...
export default function LocalizedHomePage() {
  ...
  const handleClaimSubdomain = (e: React.FormEvent) => {
    ...
    if (cleanSub) {
      router.push(`/${language}/register?subdomain=${encodeURIComponent(cleanSub)}`);
    } else {
    ...
    <div className="min-h-screen bg-[#FDFDFD] text-gray-900 font-sans selection:bg-orange-100 selection:text-orange-900">
      ...
      <section className="relative overflow-hidden pt-12 pb-20 sm:pt-20 sm:pb-28">
        ...
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 text-center">
          <div className="inline-flex items-center gap-2 rounded-full  px-4 py-1.5 text-xs font-semibold text-blue-700 backdrop-blur-sm shadow-sm">
            {/* <span className="flex h-2 w-2 rounded-full bg-orange-600 animate-pulse" /> */}
            {t("hero.badge")}
          </div>

          <h1 className="mt-6 text-3xl font-extrabold tracking-tight text-gray-950 sm:text-5xl sm:leading-[1.15]">
            {t("hero.heading1")}
            <br />
          ...
          >
            <div className="flex w-full items-center px-3 py-2 sm:py-1">
              <span className="text-md font-semibold text-gray-800 mr-1 select-none">https://</span>
              <input
                type="text"
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
          <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
            ...
            <div>
              ...
              <ul className="mt-4 space-y-2.5 text-xs text-gray-600">
                <li>
                  <Link href={`/${language}/login`} className="hover:text-orange-600 transition">
                    {t("footer.vendorLogin")}
                  </Link>
                </li>
                <li>
                  <Link href={`/${language}/register`} className="hover:text-orange-600 transition">
                    {t("footer.registerStore")}
                  </Link>
                </li>
                <li>
                  <Link href={`/${language}/dashboard`} className="hover:text-orange-600 transition">
                    {t("footer.dashboardOverview")}
                  </Link>
                </li>
                <li>
                  <Link href={`/${language}/dashboard/products`} className="hover:text-orange-600 transition">
                    {t("footer.productManagement")}
                  </Link>
                </li>
                <li>
                  <Link href={`/${language}/dashboard/orders`} className="hover:text-orange-600 transition">
            ...
            <div>
              ...
              <ul className="mt-4 space-y-2.5 text-xs text-gray-600">
                <li>
                  <Link href={`/${language}/dashboard/settings`} className="hover:text-orange-600 transition">
          ...
          <div className="mt-12 border-t border-gray-100 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-gray-400">
            ...
            <div className="flex items-center gap-6">
              ...
              <Link href={`/${language}/register`} className="hover:text-gray-600 transition">
