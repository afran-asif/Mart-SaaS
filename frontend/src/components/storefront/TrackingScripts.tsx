...
export default function TrackingScripts({
    ...
    useEffect(() => {
        ...
        if (facebookPixelId && typeof w.fbq === "function") {
            w.fbq("track", "PageView");
        }

        if (googleAnalyticsId && typeof w.gtag === "function") {
            w.gtag("config", googleAnalyticsId, { page_path: pathname });
        }

        if (tiktokPixelId && typeof w.ttq === "function") {
            w.ttq.page();
        }
    }, [pathname, facebookPixelId, googleAnalyticsId, tiktokPixelId]);
